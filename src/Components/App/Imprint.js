    ...
    return (
        <>
            <section className='impressum'>
                ...
                <p><strong>Betreiber:</strong> <br /></p>
                <p>Heidrun Holzapfel-Little <br />
            Hügelstraße 14<br />
            65527 Niedernhausen <br />
                </p>
                <p><strong>Kontakt:</strong> <br />
            Telefon: +49 151 1135 3000<br />
            E-Mail: heidi (at) tomlittle.org</p><br />
            ...
            <div className="style">
                <Container fluid>
                    <Row>
                        <Col className="d-flex justify-content-center" >Copyright © Heidrun Holzapfel-Little 2018-2020</Col>
                        <Col className="d-flex justify-content-center" ><Link to="/">Home</Link></Col>
                    </Row>
                </Container>
            </div>
